...
<html>
  ...
  <body>
    <div id="explanation">
	  ...
	  <a style="cursor:pointer;text-decoration:underline" onclick="window.open('https://feedly.com/i/discover/sources/search/' + location.href);">Send RSS feed url to Feedly</a>
    </div>
